...
function procesarCadenas()
{
    ...
    var longitudFull=fullname.lenght; // <-- COMPLETA EL CÓDIGO CORRECTO
    ...
    //var extracto=fullname.substr(0, 3); // <-- CORRIGE Y COMPLETA EL CÓDIGO
...
function procesarCadenas()
{
    ...
    // Del Nombre completo extrae la subcadena comprendida entre las posiciones 5 y 10.
    var extracto=fullName.substr(5, 6);; // <-- CORRIGE Y COMPLETA EL CODIGO
    console.log("Extracto [5 a 10]: "+extracto);
    ...
    // En el Nombre completo remplaza Pedro por Antonio
    var nuevoNombre=nombre.replace("Pedro", "Antonio");; // <-- CORRIGE Y COMPLETA EL CÓDIGO
    console.log("Nuevo nombre: "+nuevoNombre);
